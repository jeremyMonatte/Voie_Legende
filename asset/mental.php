<svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	...
	<style type="text/css">
		#mental .st0{fill:url(#mentalSVGID_1_);}
	</style>
	<g id="main">
			<linearGradient id="mentalSVGID_1_" gradientUnits="userSpaceOnUse" x1="49.9857" y1="100" x2="49.9857" y2="1.984070e-02" gradientTransform="matrix(1 0 0 -1 0 100)">
	...
	<path id="cheminD" class="st4" d="M83.4,79.5c-2.4,2.3-22.6,21.3-32.2,15.8c-8.7-5-7.7-29.7,2.5-46.5C61.5,36,73.2,27.3,71,21.7 c-2.1-5.5-17.2-4.6-20.3-11.7c-1-2.1-1-4.4-0.7-7.2" fill="none" />
	...
	<linearGradient id="grad1" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" style="stop-color:#0c0f2b;stop-opacity:1" />
